...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OriginSteering) DeepCopyInto(out *OriginSteering) {
	*out = *in
	if in.Policy != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OriginSteering.
func (in *OriginSteering) DeepCopy() *OriginSteering {
	if in == nil {
		return nil
	}
	out := new(OriginSteering)
