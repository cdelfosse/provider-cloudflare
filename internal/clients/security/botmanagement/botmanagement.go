...
func (c *CloudflareBotManagementClient) Get(ctx context.Context, zoneID string) (*v1beta1.BotManagementObservation, error) {
...
func (c *CloudflareBotManagementClient) Update(ctx context.Context, params v1beta1.BotManagementParameters) (*v1beta1.BotManagementObservation, error) {
	rc := &cloudflare.ResourceContainer{
...
func (c *CloudflareBotManagementClient) IsUpToDate(ctx context.Context, params v1beta1.BotManagementParameters, obs v1beta1.BotManagementObservation) (bool, error) {
...
func convertParametersToBotManagement(params v1beta1.BotManagementParameters) cloudflare.UpdateBotManagementParams {
...
func convertBotManagementToObservation(botManagement cloudflare.BotManagement) *v1beta1.BotManagementObservation {
	obs := &v1beta1.BotManagementObservation{
